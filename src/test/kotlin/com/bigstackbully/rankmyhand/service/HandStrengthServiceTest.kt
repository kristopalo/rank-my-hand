...
class HandStrengthServiceTest {
    ...
    private fun createHandFromRankNotation(rankNotationString: String): Hand {
    ...
    // TODO Kristo @ 02.11.2025 -> Uncomment back in, once input test data has been converted to standard notation
//    @Test
...
//            val hand = createHandFromRankNotation(rankNt)
//
//            // act
