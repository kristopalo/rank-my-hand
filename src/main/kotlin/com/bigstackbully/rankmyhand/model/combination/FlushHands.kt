...
val FLUSH_HANDS: Map<String, HandCombination> by lazy {
    val mapper = jacksonObjectMapper()
    val stream: InputStream = object {}.javaClass.getResourceAsStream("/flush_hands.json")
        ?: error("Resource not found: flush_hands.json")
